...
for Year in YEARS:
    ...
    url = f"https://web-api.tp.entsoe.eu/api?securityToken={ENTSOE_API_KEY}&documentType=A44&out_Domain=10YAT-APG------L&in_Domain=10YAT-APG------L&periodStart={period_start}&periodEnd={period_end}"
    ...
    BLOB_NAME = f"data/entsoe/Trading/entsoe_data_Trading{Year}.parquet"
